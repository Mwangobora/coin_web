...
export function StationSummaryCard({ data }: { data: QrResolution }) {
  return (
    <section className="rounded-2xl bg-[#172033] p-5 text-white shadow-lg">
      <p className="text-sm font-bold text-blue-100">You are charging at</p>
      <h1 className="mt-1 break-words text-3xl font-black leading-tight">
        {data.station.name}
      </h1>
      <p className="mt-3 flex items-start gap-2 text-sm leading-6 text-blue-100">
